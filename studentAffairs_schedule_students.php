                                        ...
                                        <div class="row">
                                            ...
                                            <div class="card-header">
                                                ...
                                                <div class="card-header-right">
                                                        ...
                                                        <a href="studentAffairs_schedule.php"  class="btn btn-primary " style="border-radius: 50px; font-size: 20px; font-weight: bold;"><i class="fa fa-refresh text-light "></i> SCHEDULE STUDENT(s)</a>
