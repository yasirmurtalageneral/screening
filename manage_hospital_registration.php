                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Manage Hospitals Birth Registration</h5>
                               <!--              <p class="m-b-0">Welcome to FastMoney</p> -->
                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="#!"> Hospitals Birth Registration</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <div class="page-body">
                                        <div class="row">
                                            ...
                                            <div class="card-header">
                                                <h3>Manage Hospitals Birth Registration</h3>
