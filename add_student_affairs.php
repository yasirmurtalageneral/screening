                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-7">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Student Affairs</h5>
                                            <p class="m-b-0">Add Student Affairs</p>
                                        </div>
                                    </div>
                                    <div class="col-md-5">
                                        <ul class="breadcrumb">
                                            <li class="breadcrumb-item">
                                                <!-- <a href="#!" style="font-size: 30px;"> Registered Student Affairs: <b> <?= $hospital_count; ?> </b></a> -->
                                            </li>
                                            ...
                                            <div class="col-sm-10">
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h3 class="">Add Student Affairs</h3>
                                                        ...
                                                        <form method="post">
                                                            <div class="row">
                                                                <div class="form-group form-info col-md-6">
                                                                    ...
                                                                    <input type="text" name="name" size="11" class="form-control" required>
                                                                    <span class="form-bar"></span> 
                                                                </div>
                                                                <div class="form-group form-info col-md-6">
                                                                    <label class="float-label">College</label>
                                                                 ...
                                                                 <div class="form-group form-info col-md-6 offset-sm-3 mt-4">
                                                                    <button type="submit" name="btn_add_student_affairs" class="form-control btn btn-primary">SUBMIT</button>
                                                                </div>
                                                            </div>
                                                        </form>
                                                    </div>
