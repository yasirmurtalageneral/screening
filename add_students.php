                                            ...
                                            <div class="col-sm-10">
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h3 class="">Upload Student List</h3>
                                                        ...
                                                        <form method="post" enctype="multipart/form-data">
                                                            <div class="row">
                                                                <div class="form-group form-info col-md-6 offset-sm-3">
                                                                    <label class="float-label">Uploade Student File (CSV file format only)</label>
                                                                    <input type="file" name="file" class="form-control" required>
                                                                    <span class="form-bar"></span> 
                                                                </div>
                                                                
                                                                 <div class="form-group form-info col-md-6 offset-sm-3 mt-4">
                                                                    <button type="submit" name="btn_upload_students" class="form-control btn btn-primary">SUBMIT</button>
                                                                </div>
                                                            </div>
                                                        </form>
                                                    </div>
