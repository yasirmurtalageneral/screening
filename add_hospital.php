                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-7">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Hospital</h5>
                                            <p class="m-b-0">Add Hospital</p>
                                        </div>
                                    </div>
                                    <div class="col-md-5">
                                        <ul class="breadcrumb">
                                            <li class="breadcrumb-item">
                                                <a href="#!" style="font-size: 30px;"> Registered Hospital: <b> <?= $hospital_count; ?> </b></a>
                                            </li>
                                                        ...
                                                        <form method="post">
                                                            <div class="row">
                                                                <div class="form-group form-info col-md-6">
                                                                    <label class="float-label">Hospital Name</label>
                                                                ...
                                                                <div class="form-group form-info col-md-6">
                                                                    ...
                                                                    <select class="form-control" name="location">
                                                                        ...
                                                                        <option value="Federal low cast">Federal low cast</option>
                                                                ...
                                                                <div class="form-group form-info col-md-12">
                                                                 ...
                                                                 <div class="form-group form-info col-md-6 offset-sm-3 mt-4">
                                                                    <button type="submit" name="btn_send" class="form-control btn btn-primary">SUBMIT</button>
                                                                </div>
                                                            </div>
                                                        </form>
                                                    </div>
